...
from utils import MAPS, Scales, Transform, TransformTrain, extract_features, visualize_output_and_save, dice_loss, \
    sigmoid
...
parser.add_argument("-dp", "--data_path", type=str, default='./data_fsc/', help="Path to the TreeFsc dataset")
...
for epoch in range(0, args.epochs):
    ...
    if best_mae >= val_mae:
        ...
        best_rmse = val_rmse
        if args.backbone == 'ResNet50FPN':
            bgmodel_name = "Modelargs" + "/mixfsc/{}bgmodel_withAttension{}.pth".format(50, epoch)
            regressor_model_name = "Modelargs" + "/mixfsc/{}regressor_withAttension{}.pth".format(50, epoch)
        else:
            bgmodel_name = "Modelargs" + "/mixfsc/cbam/{}1bgmodel_withcbam{}.pth".format(101, epoch)
            regressor_model_name = "Modelargs" + "/mixfsc/cbam/{}regressor_withcbam{}.pth".format(101, epoch)
